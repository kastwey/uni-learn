...
namespace UniLearn.Abstractions.Services;

/// <summary>
/// Represents the interface for managing card decks.
/// </summary>
public interface ICardDeckService
{
	...
	/// <summary>
	/// Gets the count of cards in a card deck.
	/// </summary>
	/// <param name="cardDeckId">The ID of the card deck.</param>
	/// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
	...
	/// <summary>
	/// Gets the cards in a card deck that are due for review at a specific date and time.
	/// </summary>
	/// <param name="cardDeckId">The ID of the card deck.</param>
